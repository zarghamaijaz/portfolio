  ...
  return (
    <div className={`flex ${isEven && "flex-row-reverse"}`}>
      <div className="flex-1 mb-6">
        <div className="bg-elements p-6 border border-gray-700 rounded">
      ...
      <div className="flex-1 self-center">
        {date && (
        <div className={`${isEven && "ml-auto"} bg-foreground px-4 py-2 text-sm text-background w-fit rounded-md`}>{date}</div>
        )}
      </div>
    </div>
  );
