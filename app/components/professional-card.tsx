...
const ProfessionalCard = () => {
    return (
        <div className="relative isolate bg-[#252525] max-w-[500px] pt-10 lg:pt-[60px] p-5 lg:p-[30px] rounded-2xl overflow-hidden">
            ...
            <div className="grid grid-cols-2 items-end gap-4">
                <div>
                    ...
                    <div className="mt-4 text-xs lg:text-sm text-gray-300">
                ...
                <div className="flex justify-end">
                    <Image src="/logo.svg" height={50} width={100} alt="Zargham" className="w-[80px] lg:w-[100px]" />
                </div>
            </div>
        </div>
    );
